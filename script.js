...
function resetGame() {
    ...
    // Reset joystick state completely
    joystickState.isDragging = false;
    joystickState.currentX = 0;
    joystickState.currentY = 0;
    joystickState.smoothX = 0;
    joystickState.smoothY = 0;
    joystickState.velocityX = 0;
    joystickState.velocityY = 0;
}
...
function handleJoystickMove(clientX, clientY) {
    ...
    // Update handle position immediately for responsive feel
    const handleSize = joystickHandle.offsetWidth / 2;
